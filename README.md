...
Database and web application both run on Docker.  
...
docker build -t vb/vaccine-booking .  
docker run -d -p 8080:8080 --name vaccine-booking --network derby-network vb/vaccine-booking  
